...
### Best Models
The data for the adjusted squared has a best model for length. We can determine this summary has a p-value of 2.2e-16.
...
This chart probides that the best overall model is L3 and Width.
